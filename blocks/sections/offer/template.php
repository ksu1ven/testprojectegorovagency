			...
			<div class="col col-12 col-xl-6 offer__right-col">
				...
				<?php if (have_rows('tabs_list')) : ?>
							...
							foreach ($tabs as $index=>$tab) {
								...
								?>
								<a
									class="nav-item nav-link <?php if ($index == '0'){ ?>active<?php   } ?> offer__nav-link"
									id="nav-<?php echo esc_html($tab_item); ?>-tab"
									data-toggle="tab"
									href="#nav-<?php echo esc_html($tab_item); ?>"
									role="tab"
									aria-controls="nav-<?php echo esc_html($tab_item); ?>"
									aria-selected="true"
									><?php echo esc_html($tab_item); ?></a
								>
					<?php
					}
					?>
					...
					<?php
						...
						<div
							class="tab-pane fade show <?php if ($index == '0'){ ?>active<?php   } ?> offer__tab-pane"
							id="nav-<?php echo esc_html($tab_item); ?>"
							role="tabpanel"
						...
						<?php
							...
							<a class="tab-info__block" href="javascript:void(0)">
									...
									<span class="tab-info__name"><?php echo esc_html($text); ?></span>
								</a>			
						<?php
						}
						?>
