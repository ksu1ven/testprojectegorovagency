...
const initMapFooter = $el => {
	const lat = parseFloat( $el.attr('data-marker-lat') )
	const lng = parseFloat( $el.attr('data-marker-lng') )
...
const init = function() {
	const $section = $( this )
	const $footerMap = $section.find( '.footer__map-inner' )
