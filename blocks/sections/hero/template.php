...
<section class="hero js-section-hero">
	<?php if ( 'empty' !== $background_type ) : ?>
		<?php if ( 'video'=== $background_type ) : ?>
			...
			?>
			<video
			class="background-video hero__backround-video js-hero__backround-video"
				...
				<nav class="nav nav--small">	
					...
					foreach ($nav_list as $index=>$nav_item) {
						$item=$nav_item['item']
							...
							?>
							<li class="nav__li nav__li--small <?php if ($index == '0'){ ?>nav__li--active<?php   } ?>">
			...
			<div class="modal-content">
				...
				<form class="form" action="#" name="consultation">
					<div class="form__inputs">
						<div class="form__div" data-placeholder="First Name">
						...
						<div class="form__div" data-placeholder="Last Name">
						...
						<div class="form__div" data-placeholder="Email">
						...
						<div class="form__div" data-placeholder="Phone Number">
						...
						<div class="form__div" data-placeholder="Message">
