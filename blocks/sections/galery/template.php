...
<section class="galery js-section-galery">
    <div class="container">
        ...
        <div class="row no-gutters galery__content">
            <div class="col col-12 galery__grid js-galery__grid">
                ...
                <a href="#carousel" class="galery__item js-galery__item galery__item--grid" aria-label="Open popup">
                    <img class="background-img galery__img" src="<?= esc_url( $img) ?>"
        ...
        <?php endif ?>
        <button class="button button--colored galery__button js-load-more" type="button">
            Load More
        </button>
    </div>
    ...
    <div class="popup carousel js-carousel" role="dialog" tabindex="0" id="carousel">
        <button class="popup__close js-carousel-close" aria-label="Close photo carousel">
    ...
    ?>
                <picture class="background-img carousel__img js-carousel__img">
                    <img src="<?= esc_url( $img) ?>" alt="carousel-photo-<?php echo esc_html(  $index)  ?>" />
                </picture>
                <?php 
        }
        ?>
        ...
        <div class="controls carousel__controls">
            <button class="controls__prev js-prev" type="button" aria-label="Previous Image" disabled>
            ...
            <div class="controls__rounds js-controls__rounds">
                ...
                <button
                    ...
                    type="button" data-number="<?php echo esc_html(  $index + 1)  ?>" <?php if ($index + 1 == '1'){ ?>
                    disabled <?php   } ?>></button>
            ...
            <button class="controls__next js-next" type="button" aria-label="Previous Image">
                <svg role="img" aria-hidden="true" width="25" height="25">
                    <use xlink:href="#arrow-icon"></use>
                </svg>
            </button>
