 ...
 * Internal Types
 */
import { TEditBlockDispatch, TSelectFunctions } from '../../../../resources/types/libs'

export const useOnEnter = ( props: any ) => {
	const { batch } = useRegistry()
	const { moveBlocksToPosition, replaceInnerBlocks, duplicateBlocks, insertBlock }: TEditBlockDispatch = useDispatch( blockEditorStore )
	const { getBlockRootClientId, getBlockIndex, getBlockOrder, getBlockName, getBlock, getNextBlockClientId }: TSelectFunctions = useSelect( blockEditorStore )
